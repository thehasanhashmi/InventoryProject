...
<form class="relative mt-2">
        ...
        <input wire:model.debounce.300ms="search" id="action-search" class="form-input pl-9 bg-white dark:bg-gray-800" type="search" placeholder="Search by User ID, Name, Email" />
