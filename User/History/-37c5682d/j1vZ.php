                                    ...
                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-auto max-w-lg w-full max-h-full" @click.outside="modalOpen = false" @keydown.escape.window="modalOpen = false">
                                        <div class="p-6">
                                            <div class="relative">
                                                ...
                                                <div class="mb-2 text-center">
                                                    <!-- Icon -->
                                                    <div class="inline-flex rounded-full bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-700/30 dark:to-gray-700 mb-2">
                                        ...
                                        <div class="px-5 pt-4 pb-1">
                                            <div class="text-sm">
                                                ...
                                                <ul class="space-y-2 mb-4">
                                                    <li>
                                                        <button class="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border-2 border-violet-400 dark:border-violet-500 shadow-sm transition">
                                                    ...
                                                    <li>
                                                        <button class="w-full h-full text-left py-3 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                                                            <div class="flex items-center">
