...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    // Supplier Management
    Route::get('suppliers/add', [SupplierController::class, 'addSupplier'])->name('addSupplier');
    Route::get('suppliers/edit/{id}', [SupplierController::class, 'editSupplier'])->name('editSupplier');
    Route::get('suppliers/list', [SupplierController::class, 'listSupplier'])->name('listSupplier');

    // Warehouse Management
    Route::get('warehouses/add', [WarehouseController::class, 'addWarehouse'])->name('addWarehouse');
    Route::get('warehouses/edit/{id}', [WarehouseController::class, 'editWarehouse'])->name('editWarehouse');
    Route::get('warehouses/list', [WarehouseController::class, 'listWarehouse'])->name('listWarehouse');

    // Product Management
    Route::get('products/add', [ProductController::class, 'addProduct'])->name('addProduct');
    Route::get('products/edit/{id}', [ProductController::class, 'editProduct'])->name('editProduct');
    Route::get('products/list', [ProductController::class, 'listProduct'])->name('listProduct');

    Route::get('transfer/stock', [ProductController::class, 'transferStock'])->name('transferStock');
