        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-5">
            ...
            <div class="mb-4 sm:mb-0">
                <ul class="flex flex-wrap -m-1">
                    <li class="m-1">
                        <button wire:click="filterByRole('all')" class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm {{ $filter == 'all' ? 'bg-gray-900 text-white' : 'bg-white text-gray-500 hover:border-gray-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700/60' }} transition">
