<x-app-layout background="bg-white dark:bg-gray-900" headerVariant="v3" sidebarVariant="v2">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Edit Warehouse</h1>
        </div>
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="name" class="form-input w-full" type="text" value="{{ $warehouse->name }}" required />
                                </div>
                            </div>
                            <div>
                                <!-- Location -->
                                <div>
                                    ...
                                    <input id="location" class="form-input w-full" type="text" value="{{ $warehouse->location }}" required />
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editWarehouseForm').submit(function(event) {
                ...
                // Send AJAX request to update the warehouse
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/warehouses/{{ $warehouse->id }}', // Dynamic warehouse ID
                    method: 'PUT',
