                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="name" class="form-input w-full" type="text" required value="{{ $warehouse->name }}"/>
                                </div>
                            </div>
                            <div>
                                <!-- Location -->
                                <div>
                                    ...
                                    <input id="location" class="form-input w-full" type="text" required value="{{ $warehouse->location }}"/ />
                                </div>
                            </div>
