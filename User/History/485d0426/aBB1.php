<div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl mb-8">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-gray-800 dark:text-gray-100">Warehouses <span class="text-gray-400 dark:text-gray-500 font-medium">{{ $warehouses_count }}</span></h2>
    </header>
                    ...
                    @foreach($warehouses as $warehouse)
                        <tr>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium text-sky-600">{{ $warehouse->name }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-medium text-gray-800 dark:text-gray-100">{{ $warehouse->location }}</div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                <div class="space-x-1">
                                    <a href="{{ route('editWarehouse', ['id' => $warehouse->id]) }}">
