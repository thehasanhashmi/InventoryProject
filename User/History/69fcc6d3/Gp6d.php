<x-app-layout background="bg-white dark:bg-gray-900" headerVariant="v3" sidebarVariant="v2">
                        ...
                        <div class="grid gap-5 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="name" class="form-input w-full" type="text" value="{{ $product->name }}" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="sku" class="form-input w-full" type="text" value="{{ $product->sku }}" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input id="quantity_in_stock" class="form-input w-full" type="number" value="{{ $product->quantity_in_stock }}" required />
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const bearerToken = '{{ $token }}'; // Assuming the token is passed in the view
            ...
            $('#editProductForm').submit(function(event) {
                ...
                // Send AJAX request
                $.ajax({
                    url: 'http://127.0.0.1:8000/api/products/{{ $product->id }}', // Dynamic product ID
