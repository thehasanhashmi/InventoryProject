...
class ProductController extends Controller
{
    ...
    public function addProduct()
    {
        ...
        return view('inventory.product.addProduct', compact('suppliers','token'));
    }
    public function editProduct($id)
    {
        ...
        return view('inventory.product.editProduct',compact('suppliers','token','product'));
    }
    ...
    public function transferStock()
    {
        ...
        $token = auth()->user()->createToken('API Token')->plainTextToken; 
        return view('inventory.product.transferStock',compact('products', 'warehouses','token'));
    }
}
