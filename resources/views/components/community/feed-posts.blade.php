...
<div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5">
    ...
    <div class="mt-5 pt-3 border-t border-gray-100 dark:border-gray-700/60">
        <ul class="space-y-2 mb-3">
            <!-- Comment -->
            <li class="p-3 bg-gray-50 dark:bg-gray-700/30 rounded">
                <div class="flex items-start space-x-3">
        ...
        <div class="relative flex items-center justify-center !my-4">
            ...
            <div class="absolute left-4 bottom-4 right-4">
                <div class="flex items-center space-x-1">
                    <div class="text-xs font-medium text-gray-300 px-2 py-1 bg-black bg-opacity-25">0:48</div>
                    <div class="text-xs font-medium text-gray-300 px-2 py-1 bg-black bg-opacity-25">1M Views</div>
                </div>
            </div>
        </div>
    </div>
