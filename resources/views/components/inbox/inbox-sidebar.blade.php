        ...
        <div>
            ...
            <div class="px-5 py-4">
                ...
                <div class="mt-4">
                    ...
                    <ul class="mb-6">
                        <li class="-mx-2">
                            <button class="flex w-full p-2 rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] text-left" @click="inboxSidebarOpen = false">
