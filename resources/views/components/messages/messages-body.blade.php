...
>
    ...
    <div class="grow px-4 sm:px-6 md:px-5 py-6">
        ...
        <div class="flex justify-center">
            <div class="inline-flex items-center justify-center text-xs text-gray-600 dark:text-gray-400 font-medium px-2.5 py-1 bg-white dark:bg-gray-700 shadow-sm rounded-full my-5">
                Tuesday, 20 January
            </div>
        </div>
        <!-- Chat msg -->
