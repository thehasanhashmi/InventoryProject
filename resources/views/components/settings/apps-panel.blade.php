<div class="grow">
    ...
    <div class="p-6">
                    ...
                    <div class="flex flex-col h-full p-5">
                        ...
                        <footer class="mt-4">
                            <div class="flex flex-wrap justify-between items-center">
                                ...
                                <!-- Right side -->
                                <button class="btn-sm border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm flex items-center">
        ...
        <section>
            ...
            <div class="grid grid-cols-12 gap-6">
                <!-- Card 1 -->
                <div class="col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-lg">
                    <!-- Card content -->
                    <div class="flex flex-col h-full p-5">
                        <div class="grow">
                            <header>
