            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <!-- Task -->
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4" draggable="true">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <!-- Task -->
                        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-4 opacity-60" draggable="true">
                            <div class="sm:flex sm:justify-between sm:items-start">
                                <!-- Left side -->
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
